...
from .augmentation import create_identity_transformation
from .augmentation import create_elastic_transformation
from .augmentation import apply_transformation
from .augmentation import misalign
...
class Cutout(object):
    def __init__(self, model_type='superhuman'):
        ...
        if self.model_type == 'mala':
            ...
            self.min_mask_size = [10, 10, 10]
            self.max_mask_size = [20, 20, 20]
